...
> Paste this into Claude Code (or any agent with repo write access) at the root of the
> project you want audited. It is stack-agnostic: it detects what the project is built
> with and adapts. It fixes everything it safely can on its own, and stages the rest
> with exact human steps.
